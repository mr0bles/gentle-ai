...
Read the skill file at `~/.junie/skills/sdd-propose/SKILL.md` and follow it exactly.
Also read shared conventions at `~/.junie/skills/_shared/sdd-phase-common.md`.
